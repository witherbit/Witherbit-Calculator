...
{
    internal class CosElement : IMathElement
    {
        public object Instance { get; }
        public MathNumerable Elements { get => (Instance as CosControl).ThisStack.Handler.Elements; }

        public CosElement(object instance)
        {
            Instance = instance;
        }
        ...
        public string Calculate()
        {
            ...
            var result = System.Math.Cos(evaluationString.Evaluate());
        ...
        {
            var control = Instance as CosControl;

...
{
    internal class TanElement : IMathElement
    {
        public object Instance { get; }
        public MathNumerable Elements { get => (Instance as TanControl).ThisStack.Handler.Elements; }

        public TanElement(object instance)
        {
            Instance = instance;
        }
        ...
        public string Calculate()
        {
            ...
            var result = System.Math.Tan(evaluationString.Evaluate());
        ...
        {
            var control = Instance as TanControl;
